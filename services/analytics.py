...
def get_remaining_balance_summary(user):
    """
...
def get_remaining_by_branch(user, limit=10):
    """
...
def get_remaining_by_client_type(user):
    """
...
def get_remaining_by_center(user, limit=10):
    """
...
def get_top_debtors(user, limit=10):
    """
